...
exports.SOCIAL_META_SCORING = exports.META_TAGS_SCORING = exports.JSON_LD_SCORING = exports.MAIN_ENTITY_TYPES = exports.REQUIRED_SCHEMA_FIELDS = exports.MAX_SCHEMA_POINTS = exports.DIVERSITY_BONUS_THRESHOLD = exports.UNKNOWN_SCHEMA_BONUS = exports.SCHEMA_WEIGHTS = exports.SECTION_CONFIG = void 0;
/**
 * Main section configuration
 */
exports.SECTION_CONFIG = {
    id: 'structured-data',
 ...
 */
exports.UNKNOWN_SCHEMA_BONUS = 0.4; // 4 pts for new/unknown schemas
exports.DIVERSITY_BONUS_THRESHOLD = 3; // 3+ different schemas get bonus
exports.MAX_SCHEMA_POINTS = 20; // Schema Types & Completeness max points
/**
 * Required fields for schema completeness validation
 */
exports.REQUIRED_SCHEMA_FIELDS = {
 ...
 */
exports.MAIN_ENTITY_TYPES = ['Article', 'BlogPosting', 'NewsArticle', 'Product', 'LocalBusiness', 'Service'];
/**
 * JSON-LD Analysis scoring configuration
 */
exports.JSON_LD_SCORING = {
